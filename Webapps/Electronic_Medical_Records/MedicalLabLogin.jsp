...
<body>
				...
				<div class="header-right">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">					
						<ul class="nav navbar-nav navbar-left">
							...
							<li class="active"><a href="contact.html"><span>C</span><span>O</span><span>N</span><span>T</span><span>A</span><span>C</span><span>T</span> <span>U</span><span>S</span></a></li>
						</ul>		
	...
	<!--contact--><form action="LabAdminLogin" method="post">
	<div class="contact">
		<div class="container">
		<%String valied=(String) request.getAttribute("msg");
		if(valied!=null){
		%>
		<h3 align="center" style="color: red;"><%=valied%></h3>
		<%} %>
			<h3 class="title1">Medical Lab <span>Login</span></h3><br/>
			<br/>
			<h4 style="color: gray;" align="center">^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</h4>
