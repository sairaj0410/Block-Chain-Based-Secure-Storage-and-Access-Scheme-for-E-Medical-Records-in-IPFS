...
<body>
				...
				<div class="header-right">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">					
						<ul class="nav navbar-nav navbar-left">
							...
							<li><a href="PatientLogn.jsp" class="link link--yaku">PATIENT LOGIN</a></li>
							</ul>		
	...
	<!--contact--><form action="PasenteRegister" method="post" enctype="multipart/form-data">
	<div class="contact">
		<div class="container">
			<h3 class="title1">Patients <span>Registration</span> Form</h3>
			<div class="contact-info" align="center">
				<div class="col-md-8 contact-grids" >
					<div class="contact-form">	
						
						    <input type="text" name="name" placeholder="Name" required=""><br/><br/>
						    <input type="text" name="fathername" placeholder="FatherName" required=""><br/><br/>
						    <input type="text" name="phone" placeholder="Phone" required=""><br/><br/>
						    <input type="email" name="email" placeholder="Email" required=""><br/><br/>
						    <input type="password" name="password" placeholder="Password" required=""><br/><br/>
						    <input type="text" name="dob" placeholder="Date Of Birth" required=""><br/><br/>
						    <input type="text" name="Gender" placeholder="Gender" required=""><br/><br/>
						    <input type="number" name="age" placeholder="Age" required=""><br/><br/>
						     <select class="custom-select" name="marital" placeholder="marital Status" requird="">
						    ...
						    <select class="custom-select"  name="category" placeholder="" required="">
								 ...
								 <input  type="text"  name="address" placeholder="Address"  required=""></textarea><br/><br/>
								...
								<input  type="text" name="country" placeholder="Country"  required=""><br/><br/>
								 <input type="file" name="photo" placeholder="Photo" required=""><br/><br/>
