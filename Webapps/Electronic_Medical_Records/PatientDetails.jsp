						...
						<div class="col-md-8 contact-grids">
							...
							<table id="customers">
								...
								<tr>
									...
									<td>
										<img
											src="http://localhost:8888/<%=pojo.getImagepath().replace("webapps", "")%>"
									...
									<td><%=pojo.getPhone()%></td>
									<td><%=pojo.getEmail()%></td>
									<td><%=pojo.getDataofbirth()%></td>

									<td><%=pojo.getCategory()%></td>
									<td>
									<a href="DeleteP?email=<%=pojo.getEmail()%>"><button style="background-color: purple;color:white;">Delete</button></a>
