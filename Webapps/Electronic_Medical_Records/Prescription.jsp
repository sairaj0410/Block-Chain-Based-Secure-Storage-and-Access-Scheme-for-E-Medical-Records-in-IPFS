							...
							<div class="contact-form">
								...
								<table id="customers">
									...
									<%
										Dao dao = new Dao();
										int i=0;
										List<PatientReportFormPojo> list = dao.getPrescriptionDetails();
										for (PatientReportFormPojo pojo : list) {
											i++;
									...
									<tr>
										...
										<td>
											<%=pojo.getAppaimentDate()%>
										</td>
										<td>
											<a href="BlockChainRetrieve?token=<%=pojo.getTokenid()%>"><%=pojo.getTokenid()%></a>
										</td>
										<%} %>
								</table>
