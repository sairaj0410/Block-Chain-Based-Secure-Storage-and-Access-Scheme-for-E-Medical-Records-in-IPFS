...
<body>
	...
	<div class="gallery-top">
		<!-- container -->
		<div class="container">
			<h3 class="title1">Doctor <span> Prescription Form</span></h3>
			<div class="gallery-grids-top">
			<%PatientReportFormPojo model = (PatientReportFormPojo) request.getAttribute("contract");%>
